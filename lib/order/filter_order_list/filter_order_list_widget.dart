...
class FilterOrderListWidget extends StatefulWidget {
  const FilterOrderListWidget({
    ...
    required this.dateStartReturn,
    required this.dateEndReturn,
    required this.statusReturn,
    required this.searchNameReturn,
    required this.searchPhone,
  });

  final String? searchField;
  final Future Function(String? dateStart, String? dateEnd, String? status,
      String? customerName, String? customerPhone)? callbackList;
  final String? dateStartReturn;
  final String? dateEndReturn;
  final String? statusReturn;
  final String? searchNameReturn;
...
class _FilterOrderListWidgetState extends State<FilterOrderListWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.dateStart = widget.dateStartReturn;
        _model.dateEnd = widget.dateEndReturn;
      });
    });

    _model.customerNameTextController ??= TextEditingController(
        text: widget.searchNameReturn != null && widget.searchNameReturn != ''
            ? widget.searchNameReturn
            : '');
    _model.customerNameFocusNode ??= FocusNode();

    _model.customerPhoneTextController ??= TextEditingController(
        text: widget.searchPhone != null && widget.searchPhone != ''
            ? widget.searchPhone
            : '');
              ...
              children: [
                    ...
                    Expanded(
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          setState(() {
                            _model.dateStart = _model.datePicked1?.toString();
                          });
                        },
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                ...
                FlutterFlowChoiceChips(
                  ...
                  controller: _model.choiceChipsValueController ??=
                    ...
                    [
                      () {
                        if (widget.statusReturn == 'draft') {
                          return 'Chưa hoàn thành';
                        } else if (widget.statusReturn == 'published') {
                          return 'Hoàn thành';
                        } else {
                          return ' ';
                        }
                    ...
                    children: [
                      Expanded(
                        child: FFButtonWidget(
                          onPressed: () async {
                            setState(() {
                              _model.customerNameTextController?.clear();
                              _model.customerPhoneTextController?.clear();
                            });
                            setState(() {
                          ...
                          onPressed: () async {
                            await widget.callbackList?.call(
                              ...
                              (_model.choiceChipsValue != null &&
                                      ...
                                      (_model.choiceChipsValue != ' ')
                                  ? (_model.choiceChipsValue == 'Hoàn thành'
                                      ? 'published'
                                      : 'draft')
                                  : ' ',
