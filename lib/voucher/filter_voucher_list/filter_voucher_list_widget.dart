...
import 'filter_voucher_list_model.dart';
export 'filter_voucher_list_model.dart';

class FilterVoucherListWidget extends StatefulWidget {
  const FilterVoucherListWidget({
    super.key,
  ...
  @override
  State<FilterVoucherListWidget> createState() =>
      _FilterVoucherListWidgetState();
}

class _FilterVoucherListWidgetState extends State<FilterVoucherListWidget> {
  late FilterVoucherListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterVoucherListModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.dateStart = functions.stringToDateTime(widget.dateStart);
        _model.dateEnd = functions.stringToDateTime(widget.dateEnd);
        _model.statusVoucher = widget.status;
        _model.priceMin = widget.priceMin;
      });
    });
    ...
    _model.textController3 ??= TextEditingController(
        text: (widget.code != '') && (widget.code != '0')
            ? widget.code
            : _model.codeVoucher);
            ...
            child: Column(
              ...
              children: [
                ...
                FlutterFlowChoiceChips(
                  options: const [ChipData('Còn hàng'), ChipData('Hết hàng')],
                ...
                FlutterFlowDropDown<String>(
                  ...
                  onChanged: (val) async {
                    ...
                    if (_model.dropDownStatusValue == '1') {
                      setState(() {
                        _model.statusVoucher = 'draft';
                      });
                    } else {
                      setState(() {
                        _model.statusVoucher = 'published';
                      });
                    }
                  },
                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        ...
                        validator: _model.priceMinTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                    Expanded(
                      child: TextFormField(
                        ...
                        keyboardType: TextInputType.number,
                        validator: _model.priceMaxTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                ...
                FlutterFlowDropDown<String>(
                  ...
                  searchHintText: 'Nhập nhà cung cấp...',
                  icon: Icon(
                    Icons.keyboard_arrow_down_rounded,
                    color: FlutterFlowTheme.of(context).secondaryText,
                    size: 24.0,
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            setState(() {
                              ...
                              _model.dateEnd = null;
                              _model.statusVoucher = null;
                              _model.priceMin = null;
                              _model.priceMax = null;
                              _model.codeVoucher = null;
                            });
