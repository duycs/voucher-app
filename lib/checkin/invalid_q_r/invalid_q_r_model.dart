...
import 'invalid_q_r_widget.dart' show InvalidQRWidget;
import 'package:flutter/material.dart';

class InvalidQRModel extends FlutterFlowModel<InvalidQRWidget> {
  ...
  // Stores action output result for [Backend Call - API (GetItem)] action in InvalidQR widget.
