...
import 'checkin_detail_model.dart';
export 'checkin_detail_model.dart';

class CheckinDetailWidget extends StatefulWidget {
  const CheckinDetailWidget({
    super.key,
    String? voucherId,
  ...
  @override
  State<CheckinDetailWidget> createState() => _CheckinDetailWidgetState();
}

class _CheckinDetailWidgetState extends State<CheckinDetailWidget> {
  late CheckinDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CheckinDetailModel());
