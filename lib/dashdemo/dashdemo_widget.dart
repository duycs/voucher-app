...
import 'dashdemo_model.dart';
export 'dashdemo_model.dart';

class DashdemoWidget extends StatefulWidget {
  const DashdemoWidget({super.key});

  @override
  State<DashdemoWidget> createState() => _DashdemoWidgetState();
}

class _DashdemoWidgetState extends State<DashdemoWidget>
    with TickerProviderStateMixin {
  late DashdemoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashdemoModel());
