...
class AgentOrderStruct extends BaseStruct {
  AgentOrderStruct({
    String? id,
    String? status,
    String? dateCreated,
  ...
  static AgentOrderStruct fromMap(Map<String, dynamic> data) =>
      AgentOrderStruct(
  ...
  static AgentOrderStruct? maybeFromMap(dynamic data) => data is Map
      ? AgentOrderStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static AgentOrderStruct fromSerializableMap(Map<String, dynamic> data) =>
      AgentOrderStruct(
        id: deserializeParam(
          data['id'],
          ParamType.String,
  ...
  @override
  String toString() => 'AgentOrderStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is AgentOrderStruct &&
        id == other.id &&
        status == other.status &&
...
AgentOrderStruct createAgentOrderStruct({
  String? id,
  String? status,
  String? dateCreated,
  String? dateUpdated,
