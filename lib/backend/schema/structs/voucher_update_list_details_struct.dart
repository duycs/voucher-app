...
class VoucherUpdateListDetailsStruct extends BaseStruct {
  VoucherUpdateListDetailsStruct({
    String? status,
    int? retailPrice,
  ...
  static VoucherUpdateListDetailsStruct fromMap(Map<String, dynamic> data) =>
      VoucherUpdateListDetailsStruct(
  ...
  static VoucherUpdateListDetailsStruct? maybeFromMap(dynamic data) =>
      data is Map
          ? VoucherUpdateListDetailsStruct.fromMap(data.cast<String, dynamic>())
          : null;
  ...
  static VoucherUpdateListDetailsStruct fromSerializableMap(
  ...
  @override
  String toString() => 'VoucherUpdateListDetailsStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is VoucherUpdateListDetailsStruct &&
        status == other.status &&
...
VoucherUpdateListDetailsStruct createVoucherUpdateListDetailsStruct({
  String? status,
  int? retailPrice,
  UserStruct? userCreated,
  UserStruct? userUpdated,
